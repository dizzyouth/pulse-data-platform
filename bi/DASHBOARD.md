...
Run `python -m src.quality.persistence` and `python -m src.warehouse.monitoring`
...
and the Phase 5.5 through 5.7 sections for anomaly, lifecycle, delivery/operations cards and filters,
