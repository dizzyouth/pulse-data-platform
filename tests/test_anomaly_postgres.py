...
class AnomalyPostgresTests(unittest.TestCase):
    ...
    def setUp(self):
        with psycopg.connect(**self.config) as connection:
            connection.execute("TRUNCATE monitoring.alert_deliveries,monitoring.alert_event_history,monitoring.alert_occurrences,monitoring.alert_events,monitoring.anomaly_results,"
